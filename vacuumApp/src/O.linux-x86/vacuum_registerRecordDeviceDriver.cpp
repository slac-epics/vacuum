...
/* Generated from ../O.Common/vacuum.dbd */
...
int vacuum_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/reg/g/pcds/package/epics/3.14-dev/modules/vacuum/current";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vacuum_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vacuum_registerRecordDeviceDriver(*iocshPpdbbase);
}
